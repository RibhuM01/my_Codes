...
template <typename T>
void SinglyList<T>::insert_at_front(T data)
{
    Node<T> *node = new Node<T>(data);
    if (node == NULL)
    {
...
template <typename T>
void SinglyList<T>::insert_at_loc(int loc, T data)
{
...
template <typename T>
void SinglyList<T>::insert_at_end(T data)
{
    Node<T> *node = new Node<T>(data);
    if (node == NULL)
    {
...
template <typename T>
void SinglyList<T>::delete_front()
{
    Node<T> *temp = head;
    head = temp->link;
    delete temp;
...
template <typename T>
void SinglyList<T>::delete_at_loc(int loc)
{
